        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-2 sm:px-3 sm:py-2 text-xs font-semibold rounded-xl border border-border bg-surface text-muted hover:text-foreground hover:border-primary/40 transition cursor-pointer shrink-0"
            ...
            <Link
              href="/create-parcel"
              className="inline-flex items-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold rounded-xl bg-primary text-primary-foreground hover:bg-primary-hover shadow-sm hover:shadow-md transition active:scale-95 cursor-pointer shrink-0 whitespace-nowrap"
            >
            ...
            <button
              ...
              className="p-2 rounded-xl border border-border bg-surface text-foreground lg:hidden cursor-pointer shrink-0"
            >
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {primaryNavLinks.map((item) => (
                    <Link
                      ...
                      className="rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs font-semibold text-foreground hover:border-primary hover:text-primary transition"
                    >
                      {item.label}
                    </Link>
                  ))}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {secondaryNavLinks.map((item) => (
                    <Link
                      ...
                      href={item.href}
                      onClick={() => setMenuOpen(false)}
                      className="rounded-xl px-3.5 py-2 text-xs font-medium text-muted hover:text-foreground hover:bg-surface-elevated transition"
                    >
                      {item.label}
                    </Link>
                  ))}
              ...
              <div className="pt-3 border-t border-border flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-primary py-2.5 px-3.5 rounded-xl bg-primary-subtle hover:bg-primary-subtle/80 transition"
                >
                ...
                <Link
                  href="/create-trip"
                  onClick={() => setMenuOpen(false)}
                  className="inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-foreground py-2.5 px-3.5 rounded-xl border border-border hover:bg-surface-elevated transition"
                >
