...
export const styles = StyleSheet.create({
  ...
  resetPill: { flexDirection: 'row', alignItems: 'center', gap: 5, minHeight: 36, paddingHorizontal: 12, paddingVertical: 6, borderRadius: BorderRadius.full, borderWidth: 1 },
  ...
  chip: { paddingHorizontal: Spacing.md, paddingVertical: 8, minHeight: 40, borderRadius: BorderRadius.full, borderWidth: 1 },
  chipText: { fontSize: FontSize.sm },
  vehicleRow: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm },
  vehicleChip: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, minHeight: 44, paddingHorizontal: Spacing.md, paddingVertical: 8, borderRadius: BorderRadius.full, borderWidth: 1 },
  vehicleChipText: { fontSize: FontSize.sm },
  applyBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', minHeight: 52, gap: Spacing.sm, paddingVertical: Spacing.md, borderRadius: BorderRadius.md },
