      ...
      <ScrollLinkedSection className="px-4 py-14 sm:px-6 md:py-20 border-y border-slate-200/80 bg-white relative z-10">
        <div className="mx-auto max-w-6xl">
          ...
          {displayTrips.length > 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="pt-4 grid grid-cols-2 gap-2">
                      <Link
                        href={`/search?from=${encodeURIComponent(trip.from_city)}&to=${encodeURIComponent(trip.to_city)}&type=trips`}
                        className="inline-flex items-center justify-center gap-1 py-2.5 rounded-xl text-xs font-bold bg-slate-900 text-white group-hover:bg-emerald-600 transition-all cursor-pointer shadow-xs"
                      >
                        <span>Find Travelers</span>
                        <ArrowRight className="w-3 h-3" />
                      </Link>
                      <Link
                        href={`/create-parcel?from=${encodeURIComponent(trip.from_city)}&to=${encodeURIComponent(trip.to_city)}`}
                        className="inline-flex items-center justify-center gap-1 py-2.5 rounded-xl text-xs font-bold bg-slate-100 hover:bg-slate-200 text-slate-700 transition-all cursor-pointer border border-slate-200"
                      >
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50/50 p-8 text-center max-w-lg mx-auto space-y-3">
              <p className="text-sm font-semibold text-slate-800">No Active Journeys Scheduled Right Now</p>
              <p className="text-xs text-slate-500">Be the first traveler to list a journey along your route, or post a parcel request.</p>
              <div className="pt-2 flex justify-center gap-3">
                ...
                <Link href="/create-parcel" className="px-4 py-2 rounded-xl text-xs font-bold bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition">
                  Send a Parcel
                </Link>
              </div>
            </div>
